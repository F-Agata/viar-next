        ...
        >
            {offerSizesItems.map((item) => (
                ...
                >
                    ...
                    <Box>
                        <TitleAndText variant={{ _: 'textMiddle', tablet: 'textLarge' }} textAlign={'center'} mb={20}>{item.title}</TitleAndText>
                    </Box>
                    <Box
                        // border={'orange 2px solid'}
                        display={'flex'}
                    ...
                    >
                        <Box
                            ...
                            mr={10}
                        >
                            <img src={'offer/dimensions.png'} alt={'dimensions'} width={'100%'}/>
                        </Box>
                        <TitleAndText variant={{ _: 'textSmall', tablet: 'textMiddle' }} textAlign={'center'} >{item.size}</TitleAndText>
                    </Box>
