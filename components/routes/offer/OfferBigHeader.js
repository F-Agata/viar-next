            ...
            <BgxBg>
                ...
                >
                    ...
                    <Box
                        ...
                        p={{ _: '120px 20px 20px 0px', tabletL: '120px 20px 20px 20px', laptopS: '100px 20px 20px 20px' }}
                        ...
                        <BoxWrappOrnament>
                            ...
                            <BoxWrappTextInsideOrnament>
                                ...
                                <TitleAndText
                                    variant={'textSmall'}
                                    // variant={{_: 'textSmallVery', tabletL: 'textSmall', }}
                                    textAlign={'center'} color={'colorSecondary'}> vitae risus</TitleAndText>
                            </BoxWrappTextInsideOrnament>
                        </BoxWrappOrnament>
                    ...
                    <BoxWrappTxt>
                        <TitleAndText variant={'textSmall'} textAlign={'center'}color={'colorSecondary'}>Aenean</TitleAndText>
                        <TitleAndText variant={'textSmall'} textAlign={'center'}> urna convallis</TitleAndText>
                    </BoxWrappTxt>
