...
const MoreInfoSmall01 = () => (
        ...
        >
            <BgxBg>
                ...
                <BoxWrappTxt>
                    <TitleAndText variant={{ _: 'textSmallVery', mobileL: 'textSmall' }} textAlign={'center'}color={'colorSecondary'}>Consectetur</TitleAndText>
                    <TitleAndText variant={{ _: 'textSmallVery', mobileL: 'textSmall' }} textAlign={'center'}> consectetur adipiscing </TitleAndText>
                </BoxWrappTxt>
