...
const MoreInfoTextPart03 = () => (
        ...
        >
            <TitleAndText variant={'title3Uppercase'} textAlign={{ _: 'center', tablet: 'left' }}color={'colorSecondary'} mb={20}> <TitleAndText as="span" color={'colorPrimary'}>Slide03 Duis ut vulputate </TitleAndText> eget arcu </TitleAndText>
            ...
            >
                ...
                <TitleAndText variant={'textSmallBold'} textAlign={'left'} >
                    <TitleAndText as="span" color={'colorSecondary'}>Etiam condimentum </TitleAndText>
            ...
            >
                ...
                <TitleAndText variant={'textSmallBold'} textAlign={'left'} color={'colorSecondary'}>
                    <TitleAndText as="span" color={'colorPrimary'}>Nunc ac mattis libero, non rhoncus erat.  </TitleAndText>
