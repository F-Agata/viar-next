...
const DoYouWantToChat = () => (
            ...
            >
                <Box width={'300px'}>
                     <TitleAndText width={'300px'} variant={'title2Uppercase'} textAlign={{ _: 'center', tablet: 'left' }} mb={20}>How can you contact us?</TitleAndText>
                </Box>
                <BoxWrapImg>
                    <QuestionMarksImg src={'contact/questionMarks.png'} alt={'questionMarks'} />
                </BoxWrapImg>
                ...
                <BoxBgBorder>
                    ...
                    >
                        <TitleAndText variant={'textLarge'} textAlign={{ _: 'center', tablet: 'left' }} mb={20}>
                            Do you want to chat?
                        </TitleAndText>
                        <TitleAndText variant={'textSmall'} textAlign={{ _: 'center', tablet: 'left' }} mb={20}>
                        ...
                        >
                            <Link href={'/#'}>
                                <Btn variant="orangeDark" m={'20px 0'} width={'100%'}><StyledAiOutlineWhatsApp /> WhatsApp</Btn>
                            </Link>
                        </Box>
